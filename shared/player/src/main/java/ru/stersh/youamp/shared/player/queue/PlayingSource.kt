...
data class PlayingSource(
    ...
    companion object {
        ...
        fun ofSong(serverId: Long, songId: String): PlayingSource {
        ...
        fun ofAlbum(serverId: Long, albumId: String): PlayingSource {
            return PlayingSource(
                serverId = serverId,
                id = albumId,
                type = Type.Album
        ...
        fun ofArtist(serverId: Long, artistId: String): PlayingSource {
            return PlayingSource(
                serverId = serverId,
                id = artistId,
                type = Type.Artist
        ...
        fun ofPlaylist(serverId: Long, playlistId: String): PlayingSource {
            return PlayingSource(
                serverId = serverId,
                id = playlistId,
                type = Type.Playlist
...
fun PlayingSource.equals(serverId: Long, audioSource: AudioSource): Boolean {
    val type = when (audioSource) {
